...
This draft merges the drafts and [green-bof-reqs].
...
This draft replaces the drafts  and [green-bof-reqs] and groups requirements from the documents of the GREEN WG proponents [charter-refinement], [operators-inputs], [GREEN-BOF], [sustainability-insights], [legacy-path] and . The aim is to determine initial sets of requirements actionable at different levels of the framework presented below {{framework}}.
...
Section 4 recalls  requirements which may fit to the GREEN WG. They still have to be grouped in tables and set with individual priorities.
...
This section extracts and groups requirements from the documents of the GREEN WG proponents [GREEN-BOF], [sustainability-insights], [legacy-path] . The aim is to determine initial sets of requirements actionable at different levels of the framework presented below {{framework}}.
...
This section groups the inputs of the work of RFC6988bis . Currently they still include a lot of verbatim text from [rfc6988] which don't fit exactly in the granularity of the current GREEN WG charter.
